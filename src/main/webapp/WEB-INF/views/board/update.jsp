        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">내용을 수정하세요.</h6>
            </div>
                ...
                <div class="col-lg-12">
                  <div class="panal panel-default">
                    ...
                    pattern="yyyy/MM/dd HH:mm:ss" var="updatedate" /> --%>
                          ...
                          <fmt:formatDate value="${now }" pattern="yyyy/MM/dd HH:mm:ss" var="updatedate" />
                          <input type="hidden" type="text" value="${updatedate }" name="updatedate">
                        </div>
                      </form>
                      <div>
                        <button style="min-width: 33%;" id="btn_update" class="btn btn-outline-primary">수정</button>
                        <button style="min-width: 33%;" id="btn_delete" class="btn btn-outline-primary">삭제</button>
